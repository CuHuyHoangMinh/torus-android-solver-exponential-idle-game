...
while True:
    ...
    # i.show()
    # i = imutils.rotate(i, angle=270,expand=True)
    ...
    if all_good:
        ...
        for st in range(len(zip_steps)):
            ...
            if di == "D":
                ...
                XX1 = XX0
                YY1 = YY0 + n * dy
            commands += "input swipe %d %d %d %d 160;" % (XX0, YY0, XX1, YY1)
        ...
        # commands = "cd /data/local/tmp/;\n"
        # # Great! Claim * Stars
        commands = "input tap 345 1130;";
        commands += "sleep 0.33;";
        # # Play Torus Puzzle
        commands += "input tap 358 873;";
        commands += "sleep 0.33;";
        # # Hard - * Stars   ---- using slow input so phone stays awake (?)
        commands += "input tap 363 746;";
        commands += "sleep  1.5;";
